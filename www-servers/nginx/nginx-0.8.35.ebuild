...
# $Header: /var/cvsroot/gentoo-x86/www-servers/nginx/nginx-0.8.35.ebuild,v 1.1 2010/04/11 19:52:34 dev-zero Exp $
...
HOMEPAGE="http://nginx.net/ http://pushmodule.slact.net/"
...
NGINX_MODULES_3RD="http_passenger http_push"

IUSE="aio debug +http +http-cache ipv6 libatomic +pcre ssl 3rdpartymodules"
